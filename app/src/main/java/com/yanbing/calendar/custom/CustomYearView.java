...
import com.yanbing.calendar.calendarview.YearView;
...
public class CustomYearView extends YearView {
    ...
    protected void onDrawMonth(Canvas canvas, int year, int month, int x, int y, int width, int height) {
        ...
        String text = getContext()
                .getResources()
                .getStringArray(com.yanbing.calendar.R.array.month_string_array)[month - 1];
    ...
    protected void onDrawWeek(Canvas canvas, int week, int x, int y, int width, int height) {
        String text = getContext().getResources().getStringArray(com.yanbing.calendar.R.array.year_view_week_string_array)[week];
        canvas.drawText(text,
                x + width / 2,
                y + mWeekTextBaseLine,
                mWeekTextPaint);
